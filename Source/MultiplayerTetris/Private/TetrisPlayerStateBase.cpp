...
ATetrisPlayerStateBase::ATetrisPlayerStateBase()
	: GameLevel(ATetrisPlayGameModeBase::DefaultGameLevel)
	, LineClearCount(ATetrisPlayGameModeBase::DefaultLineCount)
{
	SetScore(ATetrisPlayGameModeBase::DefaultScore);
}
